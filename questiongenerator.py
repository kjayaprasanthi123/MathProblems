...
def generate_math_question():
    ...
    templates = [
        {
            "scenario": "A welder cuts {x} metal rods, each {y} cm long. What is the total length?",
        ...
        {
            "scenario": "A carpenter buys {x} wooden planks. Each costs {y} rupees. What is the total cost?",
            "formula": lambda x, y: x * y
        }
    ]
    ...
    # Create question
    question_text = chosen["scenario"].format(x=x, y=y)

    # Calculate answer
    answer = chosen["formula"](x, y)
...
def generate_word_problem():
    templates = [
        {
            "scenario": "A nurse gives {x} ml of medicine to {y} patients. How much medicine is used in total?",
            "formula": lambda x, y: x * y
        },
        {
        ...
        {
            "scenario": "A carpenter buys {x} planks at {y} rupees each. What is the total cost?",
            "formula": lambda x, y: x * y
        }
    ]
